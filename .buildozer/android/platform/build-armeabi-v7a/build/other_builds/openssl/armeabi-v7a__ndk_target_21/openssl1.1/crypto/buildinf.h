...
#define DATE "built on: Fri May 14 13:43:14 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','r','e','d','s',
    '/','S','i','t','e','s','/','K','i','v','y','/','D','e','m','o',
